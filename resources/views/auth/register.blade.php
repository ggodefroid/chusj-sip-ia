...
@section('content')
<div class="container">
    <h1 class="text-center my-5">Devenir membre</h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Confirmez votre mot de passe</label>
                            ...
                            <input type="file" class="block my-2" id="cv" name="cv" accept="image/pdf">
